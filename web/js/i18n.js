...
const I18n = (function () {
  ...
  const hanVietTerms = {
    ...
    '六合':'Lục hợp','半三合':'Bán tam hợp','三合':'Tam hợp','六害':'Lục hại','六冲':'Lục xung','三刑':'Tam hình','自刑':'Tự hình','相刑':'Tương hình','半合':'Bán hợp','相害':'tương hại','合火':'hợp Hỏa','合木局':'hợp Mộc cục',
    '海中金':'Hải Trung Kim','炉中火':'Lô Trung Hỏa','大林木':'Đại Lâm Mộc','路旁土':'Lộ Bàng Thổ','剑锋金':'Kiếm Phong Kim','山头火':'Sơn Đầu Hỏa','涧下水':'Giản Hạ Thủy','城头土':'Thành Đầu Thổ','白蜡金':'Bạch Lạp Kim','杨柳木':'Dương Liễu Mộc','泉中水':'Tuyền Trung Thủy','天河水':'Thiên Hà Thủy','山下火':'Sơn Hạ Hỏa','大海水':'Đại Hải Thủy','天上火':'Thiên Thượng Hỏa','屋上土':'Ốc Thượng Thổ','长流水':'Trường Lưu Thủy','平地木':'Bình Địa Mộc','壁上土':'Bích Thượng Thổ','金箔金':'Kim Bạc Kim','佛灯火':'Phật Đăng Hỏa','钗钏金':'Thoa Xuyến Kim','桑柘木':'Tang Chá Mộc','大溪水':'Đại Khê Thủy','大驿土':'Đại Dịch Thổ','霹雳火':'Tích Lịch Hỏa','松柏木':'Tùng Bách Mộc','沙中金':'Sa Trung Kim','沙中土':'Sa Trung Thổ','石榴木':'Thạch Lựu Mộc',
